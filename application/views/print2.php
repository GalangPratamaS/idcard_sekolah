...
<body style="font-family: arial;font-size: 12px;position:absolute;">
	<div  style="width: 750px;height: 243px;margin: 50px;background-image: url('<?= base_url('asset/kartu/desain/') . $sekolah['desain']; ?>');">
		...
		<img style="position: absolute;margin-left: 360px;margin-top: 135px;" src="<?= base_url('asset/kartu/qr/test.png'); ?>" width="50px" height="50px">
		...
		<p style="margin-top: -180px;padding-left: 480px;padding-top: 10px;"><b>TATA TERTIB SEKOLAH</b><br>
