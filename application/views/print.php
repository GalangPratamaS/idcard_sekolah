...
<body style="font-size: 12px;margin-top:0;position:absolute;">
	<div id="idcard" style="width: 925px; height: 267px; margin-bottom:10px; background-image: url('<?= base_url('asset/kartu/desain/') . $sekolah['desain']; ?>');">
		...
		<img style="position: absolute;margin-left: 50px;margin-top: 135px;" src="<?= base_url('asset/kartu/qr/test.png'); ?>" width="75.5px" height="75.5px">
